...
__attribute__((section("__versions"))) = {
	...
	{ 0x78498056, __VMLINUX_SYMBOL_STR(nft_reject_ipv6_eval) },
	{ 0xcbae1e2d, __VMLINUX_SYMBOL_STR(nft_reject_ipv4_eval) },
};

static const char __module_depends[]
__used
__attribute__((section(".modinfo"))) =
"depends=nft_reject,nf_tables,nft_reject_ipv6,nft_reject_ipv4";
