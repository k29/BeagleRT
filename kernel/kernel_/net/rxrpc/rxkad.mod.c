...
__attribute__((section("__versions"))) = {
	...
	{ 0xcffb55ce, __VMLINUX_SYMBOL_STR(rxrpc_unregister_security) },
	{ 0xa6e7dcdd, __VMLINUX_SYMBOL_STR(rxrpc_register_security) },
	{ 0x60061f5f, __VMLINUX_SYMBOL_STR(rxrpc_get_server_data_key) },
