...
__attribute__((section("__versions"))) = {
	...
	{ 0xabc845ef, __VMLINUX_SYMBOL_STR(__gameport_register_port) },
	{ 0xaee04889, __VMLINUX_SYMBOL_STR(gameport_set_phys) },
	...
	{ 0x92ee414, __VMLINUX_SYMBOL_STR(gameport_unregister_port) },
