...
__attribute__((section("__versions"))) = {
	...
	{ 0x42530d78, __VMLINUX_SYMBOL_STR(dvb_usbv2_generic_rw) },
	...
	{ 0x2259cd31, __VMLINUX_SYMBOL_STR(dvb_usbv2_generic_write) },
...
MODULE_INFO(srcversion, "0EF369FD770C9C9C1D615CC");
